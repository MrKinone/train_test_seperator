...
if __name__ == '__main__':
    ...
    arg_parse.add_argument('-i', '--image_directory', type=str,  required=False, default=os.getcwd(),
                           help="Enter the path to the folder where the images are located")
    arg_parse.add_argument('-t', '--train_test_directory', type=str, required=False, default=os.getcwd(),
                           help="Enter the path of the train and test folder if the folder is not created it will be created automatically")
    arg_parse.add_argument('-r', '--ratio', type=float, required=False, default=0.8,
